...
function post(){
    let description = document.getElementById('data').innerHTML;
    let itemName = document.getElementById('name').innerHTML
    let payload = {
    ...
    $.post('/' + JSON.stringify(payload), (result) => {
...
$_mod.def("/fastify-scaffold$2.0.2/pages/slash/browser", {
  "dependencies": [
    "../layout/template/browser.json",
    "./lib.js",
    "./style.css",
    {
      "type": "js",
...
$_mod.def("/fastify-scaffold$2.0.2/pages/layout/template/browser", {
  "dependencies": [
    {
      "type": "js",
